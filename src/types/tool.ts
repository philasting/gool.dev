...
export type Category = "dev" | "text" | "image" | "doc" | "crypto" | "life" | "info" | "finance" | "ai" | "fun" | "study" | "playground" | "trending";
...
export const CATEGORIES: CategoryInfo[] = [
  ...
  { slug: "playground", label: "Playground", labelZh: "在线运行", icon: "FlaskConical", color: "text-cyan-500" },
];
